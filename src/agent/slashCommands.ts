...
export const SLASH_COMMANDS: SlashCommand[] = [
  {
    ...
    icon: '📦',
    template: 'Commit the current changes with a clear commit message: {args}',
    args: true,
  },
  {
    name: '/review',
    ...
    icon: '🔍',
    template: 'Review the code changes in detail and provide feedback: {args}',
    args: true,
  },
  {
    name: '/verify',
    ...
    icon: '✅',
    template: 'Verify the implementation works correctly: {args}',
    args: true,
  },
  {
    name: '/test',
  ...
  },
  {
    ...
    icon: '📖',
    template: 'Explain this code in detail: {args}',
    args: true,
  },
  {
    name: '/refactor',
